...
/// @nodoc
mixin _$InputObject {
  String get promptValue => throw _privateConstructorUsedError;
  String get styleValue => throw _privateConstructorUsedError;

  @JsonKey(ignore: true)
  $InputObjectCopyWith<InputObject> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $InputObjectCopyWith<$Res> {
  factory $InputObjectCopyWith(
          InputObject value, $Res Function(InputObject) then) =
      _$InputObjectCopyWithImpl<$Res, InputObject>;
  @useResult
  $Res call({String promptValue, String styleValue});
}

/// @nodoc
class _$InputObjectCopyWithImpl<$Res, $Val extends InputObject>
    implements $InputObjectCopyWith<$Res> {
  _$InputObjectCopyWithImpl(this._value, this._then);
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      promptValue: null == promptValue
          ? _value.promptValue
          : promptValue // ignore: cast_nullable_to_non_nullable
              as String,
      styleValue: null == styleValue
          ? _value.styleValue
          : styleValue // ignore: cast_nullable_to_non_nullable
              as String,
    ) as $Val);
  }
}
...
/// @nodoc
abstract class _$$_InputObjectCopyWith<$Res>
    implements $InputObjectCopyWith<$Res> {
  factory _$$_InputObjectCopyWith(
          _$_InputObject value, $Res Function(_$_InputObject) then) =
      __$$_InputObjectCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({String promptValue, String styleValue});
}
...
/// @nodoc
class __$$_InputObjectCopyWithImpl<$Res>
    extends _$InputObjectCopyWithImpl<$Res, _$_InputObject>
    implements _$$_InputObjectCopyWith<$Res> {
  __$$_InputObjectCopyWithImpl(
      _$_InputObject _value, $Res Function(_$_InputObject) _then)
      : super(_value, _then);
...
class _$_InputObject implements _InputObject {
  _$_InputObject(this.promptValue, this.styleValue);
  ...
  @override
  String toString() {
    return 'InputObject(promptValue: $promptValue, styleValue: $styleValue)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_InputObject &&
            (identical(other.promptValue, promptValue) ||
                other.promptValue == promptValue) &&
            (identical(other.styleValue, styleValue) ||
                other.styleValue == styleValue));
  }

  @override
  int get hashCode => Object.hash(runtimeType, promptValue, styleValue);

  @JsonKey(ignore: true)
  @override
  @pragma('vm:prefer-inline')
  _$$_InputObjectCopyWith<_$_InputObject> get copyWith =>
      __$$_InputObjectCopyWithImpl<_$_InputObject>(this, _$identity);
}

abstract class _InputObject implements InputObject {
  factory _InputObject(final String promptValue, final String styleValue) =
      _$_InputObject;
